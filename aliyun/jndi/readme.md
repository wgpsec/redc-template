...
**请自行替换 jdk-8u321-linux-x64.tar.gz 的压缩包下载地址**
...
**请自行替换 JNDIExploit_feihong.zip 的压缩包下载地址**
...
**请自行替换 JNDIExploit_0x727.zip 的压缩包下载地址**
- https://github.com/No-Github/Archive/tree/master/JNDI
...
**请自行替换 JNDI-Injection-Exploit-1.0-SNAPSHOT-all.jar 的压缩包下载地址**
...
**请自行替换 simplehttpserver 的压缩包下载地址**
...
2. 与阿里云 api 网络连接超时
3. 阿里云改区域售罄或下架 instance_type 的配置机型
4. jdk未正常安装
